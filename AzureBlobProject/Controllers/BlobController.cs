...
namespace AzureBlobProject.Controllers
{
    public class BlobController : Controller
    {
        ...
        {
            containerName = StripHTML(containerName);
            if(file == null || file.Length < 1) return View();
            //If the input file is: xps_img2.png, fileName would be xps_img2_GUIDHERE.png
        ...
        {
            /*Prepare Notes: Redirect() method creates a RedirectResult object that redirects(StatusCodes.Status302Found)
